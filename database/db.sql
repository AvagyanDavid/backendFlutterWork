...
CREATE TABLE IF NOT EXISTS `Barsuk`.`ArtManagerEnd_StripBarsukKazan` (
  `idArtManagerEnd` INT(11) NOT NULL AUTO_INCREMENT,
  `Date` DATE NOT NULL,
  `Time` TIME NOT NULL,
  `ReportCompletedArt` TINYINT(4) NULL DEFAULT NULL,
  `Comment_ReportCompleteArt` TINYTEXT NULL DEFAULT NULL,
  ...
  `OrderDressingRoomPhoto` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `Barsuk`.`BarmanBegin_StripBarsukKazan` (
  ...
  `CheckAndTakeAlcogolPhoto` VARCHAR(255) NULL DEFAULT NULL,
  ...
  `RubTheDishesPhoto` VARCHAR(255) NULL DEFAULT NULL,
  `Comment_RubTheDishes` TINYTEXT NULL DEFAULT NULL,
  `CommentDirector_RubTheDishes` TINYTEXT NULL DEFAULT NULL,
  `WipeDustShelving` TINYINT(4) NULL DEFAULT NULL,
  `WipeDustShelvingPhoto` VARCHAR(255) NULL DEFAULT NULL,
  `Comment_WipeDustShelving` TINYTEXT NULL DEFAULT NULL,
  `CommentDirector_WipeDustShelving` VARCHAR(45) NULL DEFAULT NULL,
  `Cleaning` TINYINT(4) NULL DEFAULT NULL,
  `CleaningPhoto` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `Barsuk`.`HostBegin_StripBarsukKazan` (
  ...
  `Comment_TakeRadioTerminalTelephone` TINYTEXT NULL DEFAULT NULL,
  ...
  `Comment_SendMessage` TINYTEXT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `Barsuk`.`HostEnd_StripBarsukKazan` (
  ...
  `WorkplacePhoto` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `Barsuk`.`WaiterBegin_StripBarsukKazan` (
  ...
  `TableArrangementPhoto` VARCHAR(255) NULL DEFAULT NULL,
  ...
  `WipeTheTablesPhoto` VARCHAR(255) NULL DEFAULT NULL,
  ...
  `InspectionOfTheHallPhoto` VARCHAR(255) NULL DEFAULT NULL,
  ...
  `ArrangeOttomansPhoto` VARCHAR(255) NULL DEFAULT NULL,
  ...
  `PutEverythingOnTheTablesPhoto` VARCHAR(255) NULL DEFAULT NULL,
  ...
  `WipeMenuPhoto` VARCHAR(255) NULL DEFAULT NULL,
